...
namespace XWorld
{
    public class AppConst {
        ...
        public const string ExtName = ".xwp";                   //资源扩展名
        public const string AssetDir = "XWorldAssets";           //资源存放目录
        public const string XWorldDir = "d:/xworld";           // 此处改为XWorldLinker目录，用于分享到XWorld中
